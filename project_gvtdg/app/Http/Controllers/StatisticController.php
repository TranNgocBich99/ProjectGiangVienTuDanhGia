...
public function report1(Request $request) {
    ...
    public function report1Science(Request $request) {
        $scienceInput = $request->post('science', '');
        $yearInput = $request->post('year', '');
        $evalID = $request->post('eval_id', '');

        $userModel = new User();
        $allUserByScience = $userModel->getUserByScience($scienceInput);
        if(!$allUserByScience->isEmpty()){
            $listUser = [];
            foreach ($allUserByScience as $usr){
                array_push($listUser, $usr->us_id);
            }
        }else{
            $listUser = [];
        ...
        //getListScience
        $scienceModel = new Science();
        $listScience = $scienceModel->GetAllScience();
        ...
        return view('admin.statistic.report1Science', compact('listYears', 'listScience', 'listEval', 'dataResDLC', 'dataResDTB'));
    }

    public function reportScience(Request $request) {
        $scienceInput = $request->post('science', '');
        $yearInput = $request->post('year', '');
        $evalID = $request->post('eval_id', '');
        ...
        return view('admin.statistic.reportScience', compact('data', 'dataChart','listYears', 'listScience', 'listEval'));
    }

    public function indexScience(Request $request) {
        $scienceInput = $request->post('science', '');
        $yearInput = $request->post('year', '');
        ...
        $totalUser = $allUserByScience->count();

        $status = count($this->model->status($scienceInput));
        ...
        return view('admin.statistic.listScience', compact('totalUser', 'status', 'ratio', 'point', 'listYears', 'listScience', 'dlcDataRes'));
    }
}

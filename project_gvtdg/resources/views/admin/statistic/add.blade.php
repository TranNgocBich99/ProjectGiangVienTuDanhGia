							...
							<input type="hidden" name="_token" value="{{ csrf_token() }}"></input>
									...
									<div class="form-group">
										...
										<div class="my_science">
											<label>Khoa</label>
											<select name="school" id="school" class="form-control" style="width:200px">
											  <option value="volvo">khoa</option>
											</select>	
										</div>
									</div>	
									...
									<div class="form-group">
										...
										<img id="avar" name = "avar" width="100px" height="30%" alt="avatar" src="/uploads/customers/20190518095616.png" accept="image/*"/>
										<input style = "margin-top:5px" type= "file" name = "avatar" value = "/uploads/customers/20190518095616.png" onchange="readURL(this);"></input>
										<script>
